...
contextBridge.exposeInMainWorld('kritamDesktop', {
  ...
  getAuditLog: (limit = 50) => ipcRenderer.invoke('audit:get-recent', limit),
  clearAuditLog: () => ipcRenderer.invoke('audit:clear'),
  getTaskHistory: (limit = 50) => ipcRenderer.invoke('task-history:get-recent', limit),
  clearTaskHistory: () => ipcRenderer.invoke('task-history:clear'),
